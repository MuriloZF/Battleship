...
def play_game():
    ...
    while player_ships_left != 0 and computer_ships_left != 0:
        ...
        print_map(computer_attack_board, f"--MAPA DO {nome_jogador}--", term_width)
    ...
    clear_screen()
    print_map(player_attack_board, f"Mapa do Ataque do {nome_jogador}", term_width)
